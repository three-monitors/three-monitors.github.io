...
const contacts = {
    ...
    callCenter: {
        ...
        info() {
            return `
            <li class="mb-2"><a href="tel:${this.phone}"> <i class="${this.icon}"></i> <span>${this.phone}: This number is tool free if calling from ${contacts.adress.country}, otherwise we advise You to use the electronic form of communication. </span></a></li>
            `;
        }
    },
    support: {
...
console.log(contacts.adress.info());
